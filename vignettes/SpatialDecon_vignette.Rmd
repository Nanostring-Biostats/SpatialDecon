...
TIL_barplot(restils$cell.counts$cell.counts, draw_legend = T, cex.names = 0.5)
# or the proportions of cells:
TIL_barplot(restils$prop_of_nontumor[, annot$AOI.name == "TME"], draw_legend = T, cex.names = 0.75)
...
par(mar = c(5,5,1,1))
layout(mat = (matrix(1:2, 1)), widths = c(6, 2))
